...
1. Download & unpack archive or <tt>git clone</tt> from Github [http://github.com/karmi/rails_i18n_demo_app]

2. You <b>have to to run edge Rails</b> for this app to work. Run this command in the app directory:

  rake rails:freeze:edge
  
3. Run <tt>script/server</tt>
