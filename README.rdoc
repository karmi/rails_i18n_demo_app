...
Simple & minimal Rails application to test the new Rails internalization and localization API
...
To test this, you have to edit <tt>/etc/hosts</tt>, putting there lines like:
